...
describe("parseCookieHeader", () => {
  ...
  describe("edge cases", () => {
    ...
    it("should handle cookies with multiple equals in complex values", () => {
      // Arrange
      const cookieHeader =
        "jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImp0aSI6ImQ5ZDBkNTM2LTg5ZjctNGU4ZS1hMWMwLWQwMzFmMzBmNzZkZSIsImlhdCI6MTY4ODQ4MzYwMCwiZXhwIjoxNjg4NDg3MjAwfQ; user=john";
  ...
  describe("real-world cookie examples", () => {
    ...
    it("should parse Supabase auth cookies pattern", () => {
      ...
      const cookieHeader =
        "sb-access-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9; sb-refresh-token=refresh123; sb-provider-token=github123";
