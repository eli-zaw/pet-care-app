  ...
  return (
    <>
      <header
        ...
        data-testid="pets-header"
      >
        <div data-testid="pets-header-info">
          <h1 className="text-3xl font-bold text-card-foreground" data-testid="pets-header-title">
            {viewModel.title}
          </h1>
          <p className="text-muted-foreground mt-1" data-testid="pets-header-count">
        ...
        {showAddButton && (
          <Button
            ...
            data-testid="pets-header-add-pet-button"
          >
            Dodaj zwierzę
          </Button>
        )}
      ...
      {showAddButton && showStickyButton && !isMobile && (
        <div
          ...
          data-testid="pets-header-sticky-cta"
        >
          <Button
            onClick={onAddPet}
            size="lg"
            className="min-h-[44px] min-w-[44px] shadow-lg"
            data-testid="pets-header-sticky-add-pet-button"
          >
            Dodaj zwierzę
          </Button>
        </div>
